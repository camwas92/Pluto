...
# parameters_decision = {'gamma':0.05,  # aka decay or discount rate, to calculate the future discounted reward.  #default 0.95
#                        'epsilon':1.0,  #  aka exploration rate, this is the rate in which an agent randomly decides its action rather than prediction. # default 1
#                        'epsilon_min':0.05, # we want the agent to explore at least this amount. # default 0.01
#                        'epsilon_decay':0.995, # we want to decrease the number of explorations as it gets good at playing games. # default 0.995
#                        'learning_rate':0.001, # Determines how much neural net learns in each iteration. # default 0.001
